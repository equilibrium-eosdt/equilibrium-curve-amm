...
use equilibrium_curve_amm::traits::Assets;
use frame_support::{
...
impl<T: Config> Assets<T::AssetId, T::Balance, T::AccountId> for Pallet<T> {
    fn create_asset() -> Result<T::AssetId, DispatchError> {
    ...
    fn total_issuance(asset: T::AssetId) -> T::Balance {
        T::Balance::default()
    }
}
...
mod tests {
    use super::*;
    use crate as equilibrium_assets;
